...
public class TestPagehtml extends Activity implements OnClickListener {
	TextView t1,t2;
		...
		public void onClick(View view) {
	      ...
	      radiogroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
	    			...
	    			alertDialogBuilder
	    				...
	    				.setPositiveButton("Yes",new DialogInterface.OnClickListener() {
	    					public void onClick(DialogInterface dialog,int id) {
	    						// if this button is clicked, close
	    						// current activity
	    						Intent i = new Intent(getApplicationContext(), ShowScorehtml.class);
	    						time=text.getText()+"";
	       ...
	       List<HTMLTable> quants = db.getAllHTML();       
	        ...
	        HTMLTable q=db.getHTML(initial[count]);
