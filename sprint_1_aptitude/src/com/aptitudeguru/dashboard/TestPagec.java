...
public class TestPagec extends Activity implements OnClickListener {
	TextView t1,t2;
	...
	int STATIC_INTEGER_VALUE=1;
	 ...
	 int k1=0;
		...
		protected void onPause() {
	   		...
	   		super.onPause();
	   	Log.d("inside pause","inside pause");
	 	...
	 	super.onResume();
		countDownTimer.cancel();
 		Log.d("starttime1 inside resume",starttime1+"");
 		if(k1==1)
 		{
	 	timerHasStarted=false;
	 	 ...
	 	 if (!timerHasStarted) {
	 		 ...
	 		 Log.d("inside 2nd timer","in 2nd timer");
			   countDownTimer.start();
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	      ...
	      radiogroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			//RadioButton r1=(RadioButton)findViewById(R.id.option1);
				...
				{}
				//Log.d("click for radio  initial",click+"");
				Log.d("ans[click] initial",ans[click]+"");
				...
				public void onClick(View view) {
					...
					int check=b[click];
					 ...
					 CTable q=db.getC(val,cat);
				    	...
				    	Log.d("click for radio  inext",click+"");
						Log.d("b[click] next",b[click]+"");
						Log.d("checknext",check+"");	
				        Log.d("Name: ", j);
		...
		public void onClick(View view) {
			...
			{   
		      ...
		      CTable q=db.getC(val,cat);
		    	...
		    	Log.d("click for radio  prev",click+"");
				Log.d("b[click] prev",b[click]+"");
				Log.d("check prev",check+"");	
		        Log.d("Name: ", j);
