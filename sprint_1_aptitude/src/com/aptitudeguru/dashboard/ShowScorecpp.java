...
public class ShowScorecpp extends Activity {
	TextView t1;
...
Button btn_help = (Button) findViewById(R.id.btn_help);
 	   ...
 	   String date2=date1+"";
 	   String score2=score+"";
 	  db.addSbtable(new sbtable("cpp",cat,date2,score2,timetaken));
      ...
      btn_score1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				String id=allid[0]+"";
				String current=0+"";
				Intent intent=new Intent(getApplicationContext(),Resultcpp.class);
				  ...
				  // setResultcpp(Resultcpp_OK, intent);
