...
public class showscoreos extends Activity {
...
Button btn_help = (Button) findViewById(R.id.btn_help);
       ...
       DateFormat dateFormat = new SimpleDateFormat("dd/MM HH:mm");
 	   ...
 	   String date2=date1+"";
 	   String score2=score+"";
 	   db.addSbtable(new sbtable("html","os",date2,score2,timetaken));
      ...
      btn_score1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				String id=allid[0]+"";
				String current=0+"";
				Intent intent=new Intent(getApplicationContext(),Resultos.class);
				  ...
				  // setResultos(Resultos_OK, intent);
