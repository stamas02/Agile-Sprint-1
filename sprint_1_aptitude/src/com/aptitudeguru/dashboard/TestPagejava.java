...
public class TestPagejava extends Activity implements OnClickListener {
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	      ...
	      radiogroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
	    			...
	    			alertDialogBuilder
	    				...
	    				.setPositiveButton("Yes",new DialogInterface.OnClickListener() {
	    					public void onClick(DialogInterface dialog,int id) {
	    						// if this button is clicked, close
	    						// current activity
	    						Intent i = new Intent(getApplicationContext(), ShowScorejava.class);
	    					    time=text.getText()+"";
	       ...
	       // Listening Friends button click
	        btn_fav.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					//startActivity(i);
									...
									int val=a[click];
									JavaTable q=db.getJava(val,cat);
	        ...
	        int g=0;
		       List<JavaTable> quants = db.getAllJava(cat);       
		        for (JavaTable cn : quants) {
				 ...
				 count=r.nextInt(3);
			        ...
			        JavaTable q=db.getJava(initial[count],cat);
