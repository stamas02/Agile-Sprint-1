...
public class ShowScorec extends Activity {
   ...
   Button btn_home = (Button) findViewById(R.id.btn_home);
	...
	Button btn_help = (Button) findViewById(R.id.btn_help);
       ...
       // Listening Friends button click
 	   ...
 	   db.addSbtable(new sbtable("c",cat,date2,score2,timetaken));
 	        index1=0;
      index2=0;
      if(yourans[index1]==0)
      ...
      btn_score1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				String id=allid[0]+"";
				String current=0+"";
				Intent intent=new Intent(getApplicationContext(),Resultc.class);
