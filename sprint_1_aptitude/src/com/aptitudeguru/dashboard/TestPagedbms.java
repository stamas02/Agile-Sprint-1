...
public class TestPagedbms extends Activity implements OnClickListener {
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	      ...
	      radiogroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
	    			...
	    			alertDialogBuilder
	    				...
	    				.setPositiveButton("Yes",new DialogInterface.OnClickListener() {
	    					public void onClick(DialogInterface dialog,int id) {
	    						// if this button is clicked, close
	    						// current activity
	    						Intent i = new Intent(getApplicationContext(), showscoredbms.class);
	       ...
	       List<DBMSTable> quants = db.getAllDBMS();       
	        ...
	        DBMSTable q=db.getDBMS(initial[count]);
