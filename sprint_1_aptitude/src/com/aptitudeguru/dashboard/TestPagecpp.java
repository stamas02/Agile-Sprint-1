...
public class TestPagecpp extends Activity implements OnClickListener
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	      ...
	      radiogroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
	    			...
	    			alertDialogBuilder
	    				...
	    				.setPositiveButton("Yes",new DialogInterface.OnClickListener() {
	    					public void onClick(DialogInterface dialog,int id) {
	    						// if this button is clicked, close
	    						// current activity
	    						Intent i = new Intent(getApplicationContext(), ShowScorecpp.class);
	    					    time=text.getText()+"";
	       ...
	       // Listening Friends button click
	        ...
	        int g=0;
	       List<CppTable> Cpp = db.getAllCpp(cat);       
	        for (CppTable cn : Cpp) {
	        ...
	        CppTable q=db.getCpp(initial[count],cat);
